...
jQuery(window).ready(function(e){e(".nav-toggle").on("click",function(t){t.preventDefault(),e(".page-header").toggleClass("menu-visible")}),e(".menu-item.menu-item-has-children a").on("touchstart",function(t){var n=e(this);!n.hasClass("selected")&&n.next().length&&(t.preventDefault(),e(".menu-item.menu-item-has-children a.selected").removeClass("selected").next().slideUp(),n.addClass("selected").next().slideDown())});var t=200;window.location.hash.length&&e("html, body").animate({scrollTop:e(window.location.hash).offset().top-t},1e3),e("a[href*=#]:not([href=#])").click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var n=e(this.hash);if(n=n.length?n:e("[name="+this.hash.slice(1)+"]"),n.length)return e("html,body").animate({scrollTop:n.offset().top-t},1e3),!1}})});
